    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Models.User user = new User { UserName = model.Email, Email = model.Email };
        ...
        // GET: /Account/SetFirstPassword
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> SetFirstPassword(string userId, string code)
        {
            if(userId == null || code == null)
            {
                return View("Error");
            ...
            IdentityResult result = await _userManager.ConfirmEmailAsync(user, code);
            var vm = new FirstPasswordViewModel()
            {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> SetFirstPassword(FirstPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                Models.User user = await _userManager.FindByNameAsync(model.Email);
                ...
                string content = System.IO.File.ReadAllText(@"EmailTemplates/PasswordReset.html").Replace("[-url-]", callbackUrl);
                await _emailSender.SendEmailAsync(model.Email, "Faculty@francefoundation.com", "TFF - Faculty", "TFF Faculty - Password Reset", content);
        ...
        {
            Models.User user = await _signInManager.GetTwoFactorAuthenticationUserAsync();
            if (user == null)
            {
                return View("Error");
            }
