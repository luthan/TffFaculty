...
namespace WebApplication2.Migrations
{
    ...
    [Migration("20161107210816_added status codes2")]
    partial class addedstatuscodes2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebApplication2.Models.StatusCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplication2.Models.User", b =>
                {
                    b.HasOne("WebApplication2.Models.StatusCode")
                        .WithMany()
