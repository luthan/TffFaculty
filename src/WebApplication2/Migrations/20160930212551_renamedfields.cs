...
namespace WebApplication2.Migrations
{
    public partial class renamedfields : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "ArrivalDate", table: "EventFaculty");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_EventFacultyRole_FacultyRole_FacultyRoleId", table: "EventFacultyRole");
            migrationBuilder.DropForeignKey(name: "FK_EventFacultyRole_User_UserId", table: "EventFacultyRole");
            migrationBuilder.DropColumn(name: "CheckIn", table: "EventFaculty");
            migrationBuilder.DropColumn(name: "CheckOut", table: "EventFaculty");
            migrationBuilder.AddColumn<DateTime>(
                name: "ArrivalDate",
                table: "EventFaculty",
                nullable: true);
